                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(user_can('view_document'))
                                                <a href="{{ url('/admin/documents/' . $item->id) }}" title="View document">
                                                    <button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                                                </a>
                                            @endif

                                            @if(user_can('edit_document'))
                                                <a href="{{ url('/admin/documents/' . $item->id . '/edit') }}" title="Edit document">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                                </a>
                                            @endif

                                            @if(user_can('assign_document'))
                                                <a href="{{ url('/admin/documents/' . $item->id . '/assign') }}" title="Assign document">
