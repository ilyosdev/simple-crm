            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/documents') }}" title="Back">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <th> File</th>
                                    <td> @if(!empty($document->file)) <a href="{{ url('uploads/documents/' . $document->file) }}"> <i class="fa fa-download"></i> {{$document->file}}</a> @endif </td>
                                </tr>
                                <tr>
                                    <th> Status</th>
                                    <td> {!! $document->status == 1?"<i class='label label-success'>Active</i>":"<i class='label label-danger'>Not active</i>" !!} </td>
                                </tr>
                                <tr>
                                    <th> Type</th>
                                    <td>{{ $document->getType->name }}</td>
                                </tr>
                                <tr>
                                    <th> Publish date</th>
                                ...
                                @if(\Auth::user()->is_admin == 1)
                                    ...
                                    <tr>
                                        <th> Modified by</th>
                                        <td>{{ isset($document->modifiedBy->name)?$document->modifiedBy->name:"" }}</td>
                                    </tr>
                                @endif

                                <tr>
                                    <th> Assigned to</th>
                                    <td>{{ $document->assignedTo != null ?$document->assignedTo->name : "not set" }}</td>
                                </tr>
                                <tr>
                                    <th> Created at</th>
