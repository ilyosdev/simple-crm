                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(user_can('view_contact'))
                                                <a href="{{ url('/admin/contacts/' . $item->id) }}" title="View contact">
                                                    <button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                                                </a>
                                            @endif

                                            @if(user_can('edit_contact'))
                                                <a href="{{ url('/admin/contacts/' . $item->id . '/edit') }}" title="Edit contact">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                                </a>
                                            @endif

                                            @if(user_can('assign_contact'))
                                                <a href="{{ url('/admin/contacts/' . $item->id . '/assign') }}" title="Assign contact">
