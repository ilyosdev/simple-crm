                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(user_can('view_task'))
                                                <a href="{{ url('/admin/tasks/' . $item->id) }}" title="View task">
                                                    <button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button>
                                                </a>
                                            @endif

                                            @if(user_can('edit_task'))
                                                <a href="{{ url('/admin/tasks/' . $item->id . '/edit') }}" title="Edit task">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button>
                                                </a>
                                            @endif

                                            @if(user_can('assign_task'))
                                                <a href="{{ url('/admin/tasks/' . $item->id . '/assign') }}" title="Assign task">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-envelope-o" aria-hidden="true"></i> Assign</button>
                                                </a>
                                            @endif

                                            @if(user_can('update_task_status'))
                                                <a href="{{ url('/admin/tasks/' . $item->id . '/update-status') }}" title="Update task status">
                                                    <button class="btn btn-primary btn-sm"><i class="fa fa-star" aria-hidden="true"></i> Update status</button>
                                                </a>
                                            @endif
